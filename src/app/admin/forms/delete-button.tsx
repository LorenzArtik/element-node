  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader><DialogTitle>{t('Eliminare?', 'Delete?')}</DialogTitle><DialogDescription>{name} {t('(e tutte le submission)', '(and all submissions)')}</DialogDescription></DialogHeader>
          <DialogFooter>
