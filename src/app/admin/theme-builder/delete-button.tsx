  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t('Eliminare?', 'Delete?')}</DialogTitle>
            <DialogDescription>{t('Stai per eliminare', 'You are about to delete')} <b>{name}</b>. {t("L'azione non si può annullare.", 'This action cannot be undone.')}</DialogDescription>
          </DialogHeader>
          <DialogFooter>
