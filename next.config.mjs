...
const nextConfig = {
  ...
  images: {
    ...
    deviceSizes: [480, 800, 1280, 1920, 2560],
  },
  experimental: {
    serverActions: {
      bodySizeLimit: '10mb',
  ...
  compress: true,
  // Sposta la "N" del dev indicator in basso a destra (non sopra Esci)
  devIndicators: { position: 'bottom-right' },
  // HTTP cache headers: aggressive per static, off per admin/api
  async headers() {
    return [
      {
        source: '/uploads/:path*',
